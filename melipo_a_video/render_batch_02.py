...
DURATIONS={4:5.680,5:5.060,6:5.290}
...
pofi_loc={4:(-3.05,-.05,-.46),5:(-3.05,-.05,-.46),6:(-3.05,-.05,-.46)}[SCENE]
...
for o in (back,front):
 if False:
  ...
  o.scale=(1,1,1);o.keyframe_insert('scale',frame=1);o.keyframe_insert('scale',frame=FRAMES)
